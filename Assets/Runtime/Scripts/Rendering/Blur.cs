...
namespace Fletchpike.PostProcessing
{
    [Serializable]
    [PostProcess(typeof(BlurEffect), PostProcessEvent.AfterStack, "Fletchpike/Blur")]
    public sealed class Blur : PostProcessEffectSettings
    {
        public BlurModeParameter Mode = new BlurModeParameter();
        [MinMax(0, 8)] public IntParameter Downsample = new IntParameter { value = 1 };
        [Min(0)] public IntParameter BlurIterations = new IntParameter { value = 1 };
        [Min(0)] public FloatParameter BlurSize = new FloatParameter { value = 3.0f };
    }
    ...
    public sealed class BlurEffect : PostProcessEffectRenderer<Blur>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            PropertySheet sheet = context.propertySheets.Get(Shader.Find("Hidden/Fletchpike/Blur"));
